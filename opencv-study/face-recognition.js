...
function loadModels (callback) {
  var utils = new Utils('')
  var proto = './data/deploy.prototxt'
  var weights = './data/res10_300x300_ssd_iter_140000_fp16.caffemodel'
  var recognModel = './data/openface.nn4.small2.v1.t7'
...
function main () {
  ...
  document.getElementById('addPersonButton').onclick = function () {
    ...
    if (rects.length > 0) {
      ...
      var name = window.prompt('Say your name:')
      ...
      var cell2 = document.getElementById('targetImgs').insertCell(0)
